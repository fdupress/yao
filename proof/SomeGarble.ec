    ...
    (forall k, C.n{2} <= k < G.g{2} => C.bb{2}.[k] = l => DKCp.kpub{2}.[2*C.aa{2}.[k] + bti (!R.t{2}.[C.aa{2}.[k]])] = R.xx{2}.[(C.aa{2}.[k], !C.v{2}.[C.aa{2}.[k]])])).
      ...
      case ((C.bb.[G.g] = l){1}).
        ...
        auto; progress.
          ...
          cut ? : (itb ((2 * C.aa{2}.[G.g{2}] + bti (R.t{2}.[C.aa{2}.[G.g{2}]] ^^ false)) %% 2)) = (R.t{1}.[C.aa{2}.[G.g{2}]] ^^ false). case (R.t{2}.[C.aa{2}.[G.g{2}]]) => hr. rewrite xor_false /bti //=. cut ->: ((2 * C.aa{2}.[G.g{2}] + 1) %% 2) = 1 by smt. rewrite H8. idtac=>/#. idtac=>/#. rewrite xor_false. rewrite xor_false /bti //=. cut ->: ((2 * C.aa{2}.[G.g{2}]) %% 2) = 0 by smt. rewrite H8. idtac=>/#. idtac=>/#. by rewrite H22.
          cut ? : (itb ((2 * C.aa{2}.[G.g{2}] + bti (R.t{2}.[C.aa{2}.[G.g{2}]] ^^ false)) %% 2)) = (R.t{1}.[C.aa{2}.[G.g{2}]] ^^ false). case (R.t{2}.[C.aa{2}.[G.g{2}]]) => hr. rewrite xor_false /bti //=. cut ->: ((2 * C.aa{2}.[G.g{2}] + 1) %% 2) = 1 by smt. rewrite H8. idtac=>/#. idtac=>/#. rewrite xor_false. rewrite xor_false /bti //=. cut ->: ((2 * C.aa{2}.[G.g{2}]) %% 2) = 0 by smt. rewrite H8. idtac=>/#. idtac=>/#. by rewrite H23.
          ...
          cut ? : (itb ((2 * C.aa{2}.[G.g{2}] + bti (R.t{2}.[C.aa{2}.[G.g{2}]] ^^ true)) %% 2)) = (R.t{1}.[C.aa{2}.[G.g{2}]] ^^ true). case (R.t{2}.[C.aa{2}.[G.g{2}]]) => hr. rewrite xor_true /bti //=. cut ->: ((2 * C.aa{2}.[G.g{2}]) %% 2) = 0 by smt. rewrite H8. idtac=>/#. idtac=>/#. cut ->: ((2 * C.aa{2}.[G.g{2}] + 1) %% 2) = 1 by smt. rewrite H8. idtac=>/#. idtac=>/#. by rewrite H32.
          cut ? : (itb ((2 * C.aa{2}.[G.g{2}] + bti (R.t{2}.[C.aa{2}.[G.g{2}]] ^^ true)) %% 2)) = (R.t{1}.[C.aa{2}.[G.g{2}]] ^^ true). case (R.t{2}.[C.aa{2}.[G.g{2}]]) => hr. rewrite xor_true /bti //=. cut ->: ((2 * C.aa{2}.[G.g{2}]) %% 2) = 0 by smt. rewrite H8. idtac=>/#. idtac=>/#. cut ->: ((2 * C.aa{2}.[G.g{2}] + 1) %% 2) = 1 by smt. rewrite H8. idtac=>/#. idtac=>/#. by rewrite H33.     
     ...
     case (C.aa{1}.[G.g{1}] = l). 
       ...
       auto; progress. 
          ...
          cut ? : (itb ((2 * C.bb{2}.[G.g{2}] + bti (R.t{2}.[C.bb{2}.[G.g{2}]] ^^ false)) %% 2)) = (R.t{1}.[C.bb{2}.[G.g{2}]] ^^ false). case (R.t{2}.[C.bb{2}.[G.g{2}]]) => hr. rewrite xor_false /bti //=. cut ->: ((2 * C.bb{2}.[G.g{2}] + 1) %% 2) = 1 by smt. rewrite H8. idtac=>/#. idtac=>/#. rewrite xor_false /bti //=. cut ->: ((2 * C.bb{2}.[G.g{2}]) %% 2) = 0 by smt. rewrite H8. idtac=>/#. idtac=>/#. by rewrite H21.
          cut ? : (itb ((2 * C.bb{2}.[G.g{2}] + bti (R.t{2}.[C.bb{2}.[G.g{2}]] ^^ false)) %% 2)) = (R.t{1}.[C.bb{2}.[G.g{2}]] ^^ false). case (R.t{2}.[C.bb{2}.[G.g{2}]]) => hr. rewrite xor_false /bti //=. cut ->: ((2 * C.bb{2}.[G.g{2}] + 1) %% 2) = 1 by smt. rewrite H8. idtac=>/#. idtac=>/#. rewrite xor_false /bti //=. cut ->: ((2 * C.bb{2}.[G.g{2}]) %% 2) = 0 by smt. rewrite H8. idtac=>/#. idtac=>/#. by rewrite H22.
          ...
          cut ? : (itb ((2 * G.g{2} + bti (R.t{2}.[G.g{2}] ^^ (C.v{2}.[G.g{2}] ^^ oget C.gg{2}.[(G.g{2}, C.v{2}.[C.aa{2}.[G.g{2}]] ^^ true, C.v{2}.[C.bb{2}.[G.g{2}]] ^^ false)]))) %% 2)) = (R.t{1}.[G.g{2}] ^^ (C.v{2}.[G.g{2}] ^^ oget C.gg{2}.[(G.g{2}, C.v{2}.[C.aa{2}.[G.g{2}]] ^^ true, C.v{2}.[C.bb{2}.[G.g{2}]] ^^ false)])). pose gamma := (C.v{2}.[G.g{2}] ^^ oget C.gg{2}.[(G.g{2}, C.v{2}.[C.aa{2}.[G.g{2}]] ^^ true, C.v{2}.[C.bb{2}.[G.g{2}]] ^^ false)]). rewrite H8; first by idtac=>/#. case (R.t{2}.[G.g{2}] ^^ gamma) => hg. rewrite /bti //=. cut ->: ((2 * G.g{2} + 1) %% 2) = 1 by smt. done. cut ->: ((2 * G.g{2} + bti false) %% 2) = 0 by smt. done. by rewrite H25.        
          by rewrite Dword.lossless.
          cut ? : (itb ((2 * C.bb{2}.[G.g{2}] + bti (R.t{2}.[C.bb{2}.[G.g{2}]] ^^ true)) %% 2)) = (R.t{1}.[C.bb{2}.[G.g{2}]] ^^ true). case (R.t{2}.[C.bb{2}.[G.g{2}]]) => hr. rewrite xor_true /bti //=. cut ->: ((2 * C.bb{2}.[G.g{2}]) %% 2) = 0 by smt. rewrite H8. idtac=>/#. idtac=>/#. cut ->: ((2 * C.bb{2}.[G.g{2}] + 1) %% 2) = 1 by smt. rewrite H8. idtac=>/#. idtac=>/#. by rewrite H29.
          cut ? : (itb ((2 * C.bb{2}.[G.g{2}] + bti (R.t{2}.[C.bb{2}.[G.g{2}]] ^^ true)) %% 2)) = (R.t{1}.[C.bb{2}.[G.g{2}]] ^^ true). case (R.t{2}.[C.bb{2}.[G.g{2}]]) => hr. rewrite xor_true /bti //=. cut ->: ((2 * C.bb{2}.[G.g{2}]) %% 2) = 0 by smt. rewrite H8. idtac=>/#. idtac=>/#. cut ->: ((2 * C.bb{2}.[G.g{2}] + 1) %% 2) = 1 by smt. rewrite H8. idtac=>/#. idtac=>/#. by rewrite H30.     
          ...
          rewrite ?getP //=. rewrite ?xor_true ?xor_false //=. cut ->: C.bb{2}.[k3] = G.g{2} <=> false by idtac=>/#. simplify. cut ? : C.bb{2}.[k3] = G.g{2} <=> false by idtac=>/#. idtac=>/#.           
          rewrite ?getP //=. rewrite ?xor_true ?xor_false //=. cut ->: C.aa{2}.[k3] = G.g{2} <=> false by idtac=>/#. simplify. cut ? : C.aa{2}.[k3] = G.g{2} <=> false by idtac=>/#. idtac=>/#. 
          rewrite ?getP //=. rewrite ?xor_true ?xor_false //=. cut ->: C.aa{2}.[k3] = G.g{2} <=> false by idtac=>/#. simplify. cut ? : C.aa{2}.[k3] = G.g{2} <=> false by idtac=>/#. idtac=>/#. 
        ...
        inline*. 
          case (C.aa{2}.[G.g{2}] = l).      
            ...
            wp. rnd. wp. rnd{1}. rnd{2}. wp. rnd {2}. wp. rnd {2}. wp. rnd{2}. wp. rnd{1}. rnd{2}. wp. auto; progress.
              ...
              cut ->: C.aa{2}.[G.g{2}] <= l - 1 <=> false by idtac=>/#. cut ->: C.bb{2}.[G.g{2}] <= l - 1 <=> false by idtac=>/#. cut ->: C.aa{2}.[G.g{2}] = l <=> true by idtac=>/#. rewrite H1. simplify. rewrite set_set. simplify. cut ->: R.t{1}.[C.aa{2}.[G.g{2}]] ^^ false = R.t{1}.[C.aa{2}.[G.g{2}]] ^^ true <=> false by idtac=>/#. simplify. congr. congr. congr. congr. congr. congr. rewrite H9. idtac=>/#. reflexivity. idtac=>/#. congr. congr. congr. rewrite H9. idtac=>/#. reflexivity. rewrite H9. idtac=>/#. reflexivity. congr. rewrite xor_false. rewrite H12. idtac=>/#. reflexivity. congr. rewrite xor_false. rewrite H12. idtac=>/#. reflexivity. congr. rewrite H12. idtac=>/#. reflexivity. congr. congr. rewrite H9. idtac=>/#. reflexivity. congr. rewrite H9. idtac=>/#. reflexivity. congr. congr. congr. rewrite H9. idtac=>/#. reflexivity. congr. rewrite H9. idtac=>/#. reflexivity. rewrite xor_true. rewrite ?H17. rewrite H11. idtac=>/#. reflexivity. move : H21. rewrite H17 //= => ?. admit. admit. congr. congr. rewrite H9. idtac=>/#. reflexivity. congr. rewrite H9. idtac=>/#. reflexivity. congr. congr. congr. rewrite H9. idtac=>/#. reflexivity. congr. rewrite H9. idtac=>/#. reflexivity. rewrite xor_true. rewrite ?H17. rewrite H11. idtac=>/#. reflexivity. admit. admit. congr. congr. rewrite H9. idtac=>/#. reflexivity. congr. rewrite H9. idtac=>/#. reflexivity. congr. congr. congr. rewrite H9. idtac=>/#. reflexivity. congr. rewrite H9. idtac=>/#. reflexivity. rewrite ?xor_false. rewrite H12. idtac=>/#. reflexivity. rewrite ?xor_true. rewrite H11. idtac=>/#. reflexivity. congr. rewrite ?xor_false ?xor_true. idtac=>/#. 
