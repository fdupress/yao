...
let p1stage2 strcy stre n m q aa bb strfunG strx2g stri1 strr1 =
  ...
  let x = SFE.Concrete.top_Concrete_p1_stage2 (i1, "", r1) ((cy, e), funG, (), x2g) in
...
let _ =
  ...
  let state1 = file_to_list "src/main/java/dk/alexandra/fresco/suite/verifiedyao/state2simpl.dat" in
  let state2 = file_to_list "src/main/java/dk/alexandra/fresco/suite/verifiedyao/state1.dat" in
  let p1stage2inp = file_to_list "src/main/java/dk/alexandra/fresco/suite/verifiedyao/p1stage2.dat" in
